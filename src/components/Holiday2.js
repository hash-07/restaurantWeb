 ...
 return (
  <div>   
   <div className={classes.container}>
    ...
    <div className={classes.container2}>
     <div className={classes.twoImg}>
      <div>
       <img className={classes.hotels} src={hotels} />
      </div>
      <div>
       <img className={classes.holidays} src={holidays} />
      </div>
     </div>
   ...
   <div className={classes.photos}>
    ...
    <div>
        <img className={classes.img} src={house} />
        <h4 style={{marginTop : '-5px'}}>Package Name</h4>
        <h4 style={{marginTop : '-20px'}} >Package Price</h4>
    </div>
    <div>
    ...
    <div>
        <img className={classes.img} src={road} />
        <h4 style={{marginTop : '-5px'}}>Package Name</h4>
        <h4 style={{marginTop : '-20px'}} >Package Price</h4>
    </div>
   </div>
